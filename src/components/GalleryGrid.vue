<template>
  <div class="bg-white border-b pt-8 pb-4">
    <div class="container max-w-5xl mx-auto xl:max-w-6xl">
      ...
      <ul>
        <div
          class="md:grid md:grid-cols-2 md:gap-1 xl:grid-cols-3 xl:gap-2 xl:max-w-screen-xl"
        >
          <li v-for="(item, index) in gallery" :key="index">
            <div class="container mx-auto">
              ...
              <div class="flex p-5">
                <g-image
                  class="flex-1 h-64 w-auto bg-cover bg-center border border-gray-400 rounded text-center shadow-lg"
                  :src="item.repeaterImages"
                ></g-image>
              </div>
