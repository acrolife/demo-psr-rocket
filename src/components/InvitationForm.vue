      ...
      <p hidden>
        <label> Don’t fill this out: <input name="bot-field" /> </label>
                ...
                <p class="text-gray-600 text-xs italic">
                  Le système permet à la personne invitée de laisser son avis,
                  en lui laissant la possibilité d'appuyer une seule fois sur
                  "Envoyer mon avis". Suite à cela, une validation du contenu
                  devra être faite par l'administrateur Wordpress.
                </p>
