  ...
  <div class="bg-white border-b pt-10 pb-4">
    <div class="container max-w-5xl mx-auto xl:max-w-6xl">
      ...
      <ul>
        <li v-for="(card, index) in repeaterCard" :key="index">
          <div v-if="index % 2">
                  ...
                  <div class="text-gray-600 mb-8">
                    <ul>
                      ...
                      >
                        ...
                        ></div>
                        <div
                          v-if="card.repeaterParagraph[index2 + 1]"
                          class="py-2"
                        />
                      </li>
                    </ul>
...
export default {
  ...
  computed: {
    noSvgArray() {
      return this.svgArray.length ? "display: block" : "display: none";
    }
  }
};
</script>