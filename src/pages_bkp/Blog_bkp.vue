            ...
            <div class="container mx-auto">
              ...
              <div v-else>
                ...
                <g-link :to="`/blog/${item.node.slug}`">
                  ...
                  >
                    <div
                      class="flex h-40 bg-cover bg-center border-r border-t border-l border-gray-400 rounded-t text-center overflow-hidden shadow-lg md:border-l-0 md:border-b md:rounded-t-none md:rounded-r md:w-1/3 lg:h-96"
                      :style="{
                        backgroundImage:
                          'url(' + item.node.acf.repeaterCard[0].picture + ')'
                      }"
